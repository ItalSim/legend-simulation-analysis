...
, fout(std::move(name))
{
  ...
  */
  ...
  analysisManager->CreateNtuple("Steps","Neutron step data");
  
  analysisManager->CreateNtupleDColumn("NeutronStepX");             //0
  analysisManager->CreateNtupleDColumn("NeutronStepY");             //1
  analysisManager->CreateNtupleDColumn("NeutronStepZ");             //2
  analysisManager->CreateNtupleDColumn("NeutronStepTime");          //3
  analysisManager->CreateNtupleDColumn("NeutronStepKineticEnergy"); //4
  analysisManager->CreateNtupleIColumn("NeutronStepTrackID");       //5
  analysisManager->CreateNtupleIColumn("NeutronStepID");            //6
  analysisManager->CreateNtupleSColumn("NeutronStepProcess");       //7
  analysisManager->CreateNtupleSColumn("NeutronStepMaterial");      //8
  analysisManager->CreateNtupleSColumn("NeutronStepVolume");        //9
